...
Aplica\c{c}\~oes Sens\'iveis \`a Lat\^encia em Rede de Transporte 5G com Open vSwitch}
...
os mecanismos cl\'assicos de QoS \cite{rfc3246,rfc2474,araujo2013qos,pacheco2016caminhos} s\~ao
...
\cite{chaves2016sdn,grings2022slicing}.
...
nos roteadores. A atua\c{c}\~ao \\'e baseada em OpenFlow sobre
switches Open vSwitch (OVS) \cite{chaves2016sdn,chaves2016ofs13,pfaff2015ovs,mckeown2008openflow},
...
Open vSwitch (OVS) \cite{chaves2016sdn,pfaff2015ovs}, configurados via OpenFlow 1.3
\cite{chaves2016ofs13,mckeown2008openflow} para encaminhamento L2 e prioriza\c{c}\~ao de
...
\cite{rfc3246,araujo2013qos}, a porta de destino e a taxa de envio. Apresente
...
porta de destino \cite{rfc2474,pacheco2016caminhos}. Descreva o loop de controle em
...
trabalho, as regras OpenFlow\,1.3 \cite{chaves2016ofs13,mckeown2008openflow} s\~ao
instaladas diretamente nos switches Open vSwitch (OVS)
\cite{chaves2016sdn,pfaff2015ovs} do Mininet, sem a necessidade de um controlador
...
uRLLC \cite{chaves2016sdn,olegario2024qos5g,pfaff2015ovs,linuxhtb}. Compare com a baseline (sem
