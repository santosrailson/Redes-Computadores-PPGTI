	...
	\begin{document}
		...
		A Tabela~\ref{tab:vazao-embb} e a Figura~\ref{fig:vazao-embb} evidenciam que o \textit{closed loop} protege o tráfego uRLLC com o custo de uma reduzir de forma acentuada a vazão eMBB, confirmando o compromisso entre latência e vazão.
